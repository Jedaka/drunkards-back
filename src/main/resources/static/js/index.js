...
var _UserEvent = __webpack_require__(14);
...
var Actions = function () {
    ...
    _createClass(Actions, [{
        key: "addAction",
        value: function addAction(options) {
            this._buttons.push(new _Button2.default(options));
...
Actions.defaults = {
    selector: (0, _jquery2.default)(".wrap__action-buttons")
};
...
var Modal = function () {
    function Modal(options) {
        ...
        (0, _jquery2.default)(this._options.selector).modal();
    }
